This repository is now DEPRECATED, new firefox versions can be found in the [Verallel Firefox branch](https://github.com/Webb-School-Computer-Science-Club/Verallel/tree/firefox) on the normal repository.
